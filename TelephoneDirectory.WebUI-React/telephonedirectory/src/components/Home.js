      ...
      <div className="row">
        <div className="col-12">
          <nav className="main-nav">
            ...
            <ul className="nav">
              <li><a href="index.html" className="active">Anasayfa</a></li>
              <li><a href="category.html">Kategoriler</a></li>
              <li><a href="listing.html">Listeleme</a></li>
              <li><a href="contact.html">Bize Ulaşın</a></li> 
              <li><div className="main-white-button"><a href="#"><i className="fa fa-plus"></i> İlanınızı Ekleyin</a></div></li> 
            </ul>        
      ...
      <div className="row">
        <div className="col-lg-12">
          <div className="top-text header-text">
            <h6>36.500'den fazla Aktif Telefon Numarası</h6>
            <h2>Numaraları ,Yerleri &amp; Konumları  Bul</h2>
          </div>
        </div>
        <div className="col-lg-12">
          <form id="search-form" name="gs" method="submit" role="search" action="#">
			...
			<div className="col-lg-3 align-self-center"> 
              ...
              <div className="col-lg-3">                        
                  <fieldset>
                      <button className="main-button"><i className="fa fa-search"></i> Şimdi Ara</button>
                  </fieldset>
              </div>
            </div>
          </form>
